    ...
    internal sealed class Configuration : DbMigrationsConfiguration<testLogin.Models.ApplicationDbContext>
    {
        ...
        protected override void Seed(testLogin.Models.ApplicationDbContext context)
        {
            ...
            var restaurants = new List<Restaurant>
             {
                new Restaurant{id=1,restaurantName="Good Fellas Pizza Pan",latitude=53.482239,longitude=-6.3329,wheelchair=true,vegetarian=true,type1="Italian",type2="Portuguese", type3="Pizza", phoneNum="225392945", openClose="9 to late",bio="Amazing Italian food from Don Corleone", Email="mark.lordan@hello.com"},
                new Restaurant{id=2,restaurantName="Pita Pan Pita Breadsticks",latitude=53.25834,longitude=-6.64212, wheelchair=false,vegetarian=true,type1="Asian",type2="Pizza", type3="Traditional", phoneNum="5843839", openClose="9 to 5",bio="A nice bitta pita bread is always good",Email="robert_kelly@outlook.com"},
                new Restaurant{id=3,restaurantName="Thai Tanic",latitude=53.42249,longitude=-6.434329, wheelchair=false,vegetarian=false,type1="American",type2="Portuguese", type3="Pizza", phoneNum="225392945", openClose="9 to late",bio="Wok fried everything",Email="thomasmurphy41@gmail.com"},
