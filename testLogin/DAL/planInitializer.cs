...
namespace testLogin.DAL
{
    public class planInitializer :System.Data.Entity.DropCreateDatabaseIfModelChanges<planContext>
    {
        protected override void Seed(planContext context) 
        {
            ...
            {
                new Restaurant{id=1,restaurantName="Good Fellas Pizza ",latitude=-6.66,longitude=53.28,wheelchair=true,vegetarian=true,type="Italian",bio="Amazing Italian food from Don Corleone", Email="mark.lordan@me.com"},
                new Restaurant{id=2,restaurantName="Pita Pan Pita Breadsticks",latitude=-6.25,longitude=53.34, wheelchair=false,vegetarian=true,type="Café",bio="A nice bitta pita bread is always good",Email="robert_kenny@outlook.com"},
                new Restaurant{id=3,restaurantName="Thai Tanic",latitude=-6.48,longitude=53.29, wheelchair=false,vegetarian=false,type="Thai",bio="Wok fried everything",Email="thomasmurphy21@gmail.com"}
            };
            ...
            {
                new Floorplan{id=1,height=5,width=5,numObjects=10}
            };
