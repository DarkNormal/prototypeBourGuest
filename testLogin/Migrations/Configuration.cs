    ...
    internal sealed class Configuration : DbMigrationsConfiguration<testLogin.Models.ApplicationDbContext>
    {
        ...
        protected override void Seed(testLogin.Models.ApplicationDbContext context)
        {
            ...
            var restaurants = new List<Restaurant>
             {
                new Restaurant{id=1,restaurantName="Good Fellas Pizza Pan",latitude=53.482239,longitude=-6.3329,wheelchair=true,vegan=true,type1="Italian",type2="Portuguese", type3="Pizza", phoneNum="225392945", openClose="9 to late",bio="Amazing Italian food from Don Corleone", Email="mark.lordan@hello.com"},
                new Restaurant{id=2,restaurantName="Pita Pan Pita Breadsticks",latitude=53.25834,longitude=-6.64212, wheelchair=false,vegan=true,type1="Asian",type2="Pizza", type3="Traditional", phoneNum="5843839", openClose="9 to 5",bio="A nice bitta pita bread is always good",Email="robert_kelly@outlook.com"},
                new Restaurant{id=3,restaurantName="Thai Tanic",latitude=53.42249,longitude=-6.434329, wheelchair=false,vegan=false,type1="American",type2="Portuguese", type3="Pizza", phoneNum="225392945", openClose="9 to late",bio="Wok fried everything",Email="thomasmurphy41@gmail.com"},
                new Restaurant{id=4, restaurantName ="Aussie Outback", latitude=53.286374, longitude=-6.375107, wheelchair=true, vegan=false, type1="Healthy Option", phoneNum="5893923", openClose="6 to 11", bio="Aussie Outback BBQ food stuff", Email="aussieoutback@gmail.com" },
                new Restaurant{id=5, restaurantName ="Tamaras", latitude=53.286228, longitude=-6.376164, wheelchair=true,vegan=true,type1="Indian", type3="Pizza", phoneNum="59339", openClose="4 to 8", bio= "Tamara's bread, today", Email="tamaras@gmail.com"},
                new Restaurant{id=6, restaurantName="The Lemongrass", latitude=53.285983, longitude=-6.450154, wheelchair=true,vegan=true, type1="Something Different", type2="Pizza", phoneNum="2291", openClose="5 to 10", bio="Expensive and overpriced fiery food", Email="lemongrass@eircom.net"},
                new Restaurant{id=7, restaurantName="Niamh's Kitchen", latitude=53.286374, longitude=-6.375106, wheelchair=false,vegan=true,type1="Traditional",phoneNum="44554", openClose="4-9", bio="Food's ok, not great", Email="mark.lordan@email.com"}
             };
